/**
 * Mobile i18n — thin wrapper over `@bilgim/i18n`.
 *
 ...
 * `Asset.fromModule(require('@bilgim/i18n/locales/...'))` so we
...
import enCommon from '@bilgim/i18n/locales/en/common.json';
import ruCommon from '@bilgim/i18n/locales/ru/common.json';
import uzCommon from '@bilgim/i18n/locales/uz/common.json';
