...
export const enrollmentApi = {
  ...
  /** Remove an approved student from a group the caller teaches. */
  revokeEnrollment(groupId: string, studentId: string) {
    return apiClient.post<{ groupId: string; studentId: string }>(
      `/enrollment/groups/${groupId}/students/${studentId}/revoke`,
      undefined,
    );
  },
};
