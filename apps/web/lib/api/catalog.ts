...
export interface Course {
  ...
  updatedAt: string;
  /**
   * Summary counts for the course cards. Present on the teacher's course
   * list (`GET /catalog/courses`); absent on single-course reads, hence
   * optional.
   */
  groupCount?: number;
  studentCount?: number;
...
export interface Group {
  ...
  /**
   * Summary counts for the group cards. Present on the per-course group
   * list (`GET /catalog/courses/:id/groups`); absent on single-group reads.
   */
  studentCount?: number;
  lessonCount?: number;
...
export const attachmentsApi = {
  ...
  listForAssignment: (assignmentId: string) =>
    apiClient.get<Attachment[]>(
      `/catalog/assignments/${assignmentId}/attachments`,
    ),
  createForAssignment: (assignmentId: string, dto: CreateAttachmentDto) =>
