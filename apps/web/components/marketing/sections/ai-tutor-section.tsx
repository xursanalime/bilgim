    ...
    >
      ...
      <div className="border-t border-white/[0.07] bg-ink/40 px-5 py-3">
        <div className="flex items-center gap-2 rounded-2xl border border-white/[0.08] bg-white/[0.03] px-3 py-2">
          ...
          {/* Decorative mockup send button — no action; hidden from keyboard
              and the a11y tree so it isn't an unlabeled dead tab stop. */}
          <button
            aria-hidden="true"
            tabIndex={-1}
            className="flex h-7 w-7 items-center justify-center rounded-xl bg-accent2-500 text-ink"
          >
            <svg
              className="h-3 w-3"
              viewBox="0 0 24 24"
