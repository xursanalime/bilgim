...
export function VerifyEmailClient({ locale, token }: VerifyEmailClientProps) {
    ...
    authApi
      ...
      .catch((error) => {
        ...
        if (error instanceof ApiClientError) {
          ...
          setErrorMessage(getAuthErrorMessage('NETWORK_ERROR'));
        }
      });
  }, [token, status]);
    ...
    return (
      <div className="space-y-6 text-center">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-white-strong">
  ...
  if (status === 'verifying') {
    return (
      <div className="space-y-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-white-strong">
          Tekshirilmoqda...
        </h1>
        <p className="text-blue/70">Iltimos kuting</p>
      </div>
    );
  }
  ...
  if (status === 'success') {
    return (
      <div className="space-y-6 text-center">
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-teal">
          <svg
  ...
  return (
    <div className="space-y-6 text-center">
      <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-red-tint">
        <svg
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold text-white-strong">Xatolik yuz berdi</h1>
        <p className="text-white-soft">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-white-soft">
          ...
          <button
            ...
            className="font-semibold text-white-strong underline-offset-4 hover:underline"
          >
