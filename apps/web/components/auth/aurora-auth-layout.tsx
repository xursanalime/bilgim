...
export function AuroraAuthLayout({
  ...
  return (
    <div className="flex min-h-screen" style={{ backgroundColor: tokens.surface.base }}>
      {/* ── Left brand panel ──────────────────────────────── */}
      ...
      <div className="relative flex w-full flex-col lg:w-[52%] xl:w-[46%]">
        ...
        <main
          id="main-content"
          tabIndex={-1}
          className="relative z-10 flex flex-1 items-center justify-center px-4 py-8 sm:px-6 lg:px-12"
        >
          <motion.div
