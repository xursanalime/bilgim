  ...
  if (success) {
    return (
      <div className="space-y-6 text-center">
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-teal-tint ring-1 ring-inset ring-teal/30">
          <svg
    ...
    <AnimatePresence mode="wait">
      ...
      >
          ...
          <div className="flex items-center gap-3">
            <span
              className={`flex h-10 w-10 items-center justify-center rounded-xl ${
                role === 'TEACHER' ? 'bg-blue-tint text-blue' : 'bg-teal-tint text-teal'
              }`}
            >
              {role === 'TEACHER' ? (
        ...
        <FormField
          ...
          helperText="Profil URL: edubridge.uz/@username"
...
function RoleCard({
  ...
  const toneClass =
    tone === 'blue'
      ...
      : { iconBg: 'bg-teal-tint text-teal', ring: 'border-teal/40 bg-teal/[0.04]' };
