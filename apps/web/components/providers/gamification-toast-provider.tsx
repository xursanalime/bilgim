...
export function GamificationToastProvider({ children, role }: { children: React.ReactNode; role?: string }) {
        ...
        <AnimatePresence mode="popLayout">
          {toasts.map((toast) => (
            <motion.div
              ...
              className="flex items-center gap-4 rounded-2xl bg-ink-strong px-5 py-3.5 text-white shadow-xl pointer-events-auto"
            >
              <div className={cn(
