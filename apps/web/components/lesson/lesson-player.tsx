    ...
    <div className="mx-auto max-w-7xl space-y-8 pb-12">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          ...
          {lesson.description ? (
            <article className="rounded-3xl border border-rim bg-white p-6 text-sm leading-relaxed text-ink-strong shadow-soft">
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 rounded-2xl px-4 py-2 text-sm font-bold transition-all active:scale-[0.98] ${
        isWatched
          ? 'cursor-default border border-teal/20 bg-teal-tint text-teal'
