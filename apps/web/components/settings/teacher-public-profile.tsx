              ...
              {coverUrl ? (
                <>
                  ...
                  <button
                    ...
                    className="absolute right-1 top-1 flex h-5 w-5 items-center justify-center rounded-full bg-ink-strong/70 text-white opacity-0 transition-opacity hover:bg-red group-hover:opacity-100"
                  >
                    <X className="h-3 w-3" />
                  </button>
                </>
