      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.06]">
        ...
        {result && (
          <button
            ...
            aria-label={expanded ? 'Tafsilotlarni yopish' : 'Tafsilotlarni ochish'}
            aria-expanded={expanded}
            className="text-cream-dim hover:text-cream transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue/40 rounded"
          >
