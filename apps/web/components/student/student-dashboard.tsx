                  ...
                  {upcomingLessons.slice(0, 5).map(({ lesson, groupName }) => (
                    ...
                    >
                      <div className="flex min-w-0 items-center gap-4">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-green-tint text-green">
            ...
            <div className="mt-4">
              {pendingHomework.length === 0 ? (
                <div className="flex flex-col items-center rounded-2xl bg-tint p-6 text-center">
                  <CheckCircle2 className="mb-2 h-7 w-7 text-green" />
...
function JoinByCodeModal({ locale }: { locale: string }) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink-strong/60 p-4 backdrop-blur-md animate-in fade-in duration-300">
          <div
