      ...
      <div className="space-y-6">
        ...
        <header className="group relative overflow-hidden rounded-[2.5rem] border border-rim bg-white p-8 shadow-soft sm:p-10 lg:p-12">
          ...
          <div className="relative z-10 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            {myEnrollment && (
              <div className="flex items-center gap-3 rounded-2xl bg-green/5 border border-green/10 p-4 shadow-sm">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-green text-white shadow-green-soft">
                  <CheckCircle2 className="h-5.5 w-5.5" />
                </div>
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider text-green/60">Aʼzolik holati</p>
                  ...
                  {schedule.occurrences?.length ? (
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2">
                        {schedule.occurrences.slice(0, 5).map((occ) => (
                          <li
                          ...
                          >
                            <span>{formatDateTime(occ.start)}</span>
                            <span className="text-ink-faint">{formatTimeOnly(occ.end)}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
