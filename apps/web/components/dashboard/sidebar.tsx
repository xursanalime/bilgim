...
export function DashboardSidebar({ locale, role, userName, userEmail }: SidebarProps) {
  ...
  const { data: notifUnreadData } = useUnreadNotificationsCount();
  ...
  const teacherItems: NavItem[] = [
    ...
    { href: `${base}/requests`, label: "So'rovlar", icon: UserCheck },
  ...
  const studentItems: NavItem[] = [
    ...
    { href: `${base}/homework`, label: 'Uy ishlari', icon: FileText },
    { href: `${base}/schedule`, label: 'Jadval', icon: BarChart3 },
    { href: `${base}/messages`, label: 'Xabarlar', icon: MessageCircle },
    { href: `${base}/notifications`, label: 'Bildirishnomalar', icon: Bell },
    { href: `${base}/ai-chat`, label: 'BilgimAI', icon: Sparkles },
  ...
  const adminItems: NavItem[] = [
    ...
    { href: `${base}/admin/english-catalog`, label: 'Ingliz tili moduli', icon: BookOpen },
    { href: `${base}/admin/onboarding`, label: 'Onboarding', icon: GraduationCap },
    { href: `${base}/admin/cms/pages`, label: 'CMS sahifalari', icon: LayoutDashboard },
    { href: `${base}/admin/ai-prompts`, label: 'AI Promptlar', icon: MessageCircle },
    { href: `${base}/admin/audit-logs`, label: 'Audit Loglar', icon: FileText },
    { href: `${base}/admin/plans/manage`, label: 'Tariflar', icon: BarChart3 },
    ...
    <aside className="sticky top-0 hidden h-screen w-72 shrink-0 border-r border-rim bg-white lg:flex lg:flex-col">
      ...
      <nav className="flex-1 space-y-1 px-4 py-6">
        ...
        {items.map((item) => {
          ...
          else if (item.label === "Bildirishnomalar") badgeCount = notifUnreadCount;
      ...
      <div className="border-t border-rim bg-tint/30 pt-4 pb-6">
        {role === 'STUDENT' && <XpBadge locale={locale} variant="card" />}
