...
import { BookOpen, MoreVertical, Signal, Users, Layers, ArrowRight } from 'lucide-react';
        ...
        <div key={course.id} className="group relative">
          ...
          >
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <button className="flex h-8 w-8 items-center justify-center rounded-lg text-ink-faint transition-colors hover:bg-tint hover:text-ink-strong">
