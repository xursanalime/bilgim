...
export function XpBadge({ locale, variant = 'badge' }: XpBadgeProps) {
  ...
  // Close dropdown on Esc while open (custom popover; Req 7.2).
  useEffect(() => {
    if (!isOpen) return;
    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="mx-3 mb-2 flex w-[calc(100%-1.5rem)] flex-col rounded-xl border border-blue/15 bg-blue/5 p-3 text-left transition-all hover:border-blue/30 hover:bg-blue/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue focus-visible:ring-offset-1"
        >
          <div className="mb-2 flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="h-1.5 overflow-hidden rounded-full bg-blue/15 shadow-inner">
                <motion.div
                  initial={{ width: 0 }}
  ...
  return (
    <div className="relative w-full sm:w-auto" ref={dropdownRef}>
      <button
        ...
        aria-expanded={isOpen}
        className={cn(
          'group flex h-10 w-full sm:w-auto items-center gap-2 rounded-full border bg-white px-1.5 shadow-sm transition-all hover:bg-tint focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue focus-visible:ring-offset-1',
