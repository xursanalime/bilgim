    ...
    <section className="rounded-3xl border border-rim bg-canvas p-6 shadow-soft">
      <div className="flex items-center justify-between">
        ...
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-tint">
          <Layers className="h-4.5 w-4.5 text-ink-soft" />
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="mt-6 flex h-[140px] flex-col items-center justify-center rounded-2xl bg-tint text-xs text-ink-soft">
