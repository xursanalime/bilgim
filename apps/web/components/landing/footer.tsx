...
export function Footer({ locale, text }: { locale: string; text?: string }) {
  return (
    <footer className="relative border-t border-rim bg-canvas">
      <div className="container-aurora py-16">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-12">
          ...
          <div className="col-span-2 md:col-span-4">
            ...
            <div className="mt-6 flex gap-2">
              <Social href="https://t.me/bilgim_uz" label="Telegram">
                <Telegram />
              </Social>
...
function Column({
  ...
  return (
    <div className="md:col-span-2">
      <h4 className="font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-ink/80">
        {title}
      </h4>
