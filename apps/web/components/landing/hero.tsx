 ...
 *
 * Composition:
 *   - Soft gray-white background with subtle blue orbs
...
function RightIllustration() {
  return (
    ...
    >
      {/* Main dashboard card */}
      <div
        className="liquid-glass-strong overflow-hidden rounded-3xl p-2 sm:rounded-[2rem] sm:p-3"
      >
        {/* Window header */}
        <div className="flex items-center justify-between rounded-t-2xl border-b border-rim/60 bg-canvas px-4 py-3">
          ...
          <span className="rounded-full bg-teal/10 px-2 py-0.5 font-mono text-[9px] font-bold uppercase tracking-[0.15em] text-teal">
            Live
          </span>
        </div>

        {/* Body */}
        <div className="grid grid-cols-12 gap-2 p-3 pb-8 sm:gap-3 sm:p-4 sm:pb-10">
          {/* Sidebar */}
