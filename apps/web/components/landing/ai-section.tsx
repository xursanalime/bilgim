      ...
      <div className="container-page relative">
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-5">
            ...
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-teal-tint">
                <Lock className="h-4 w-4 text-teal" strokeWidth={2.25} />
              </span>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 border-b border-rim bg-purple-tint/40 px-5 py-2">
        ...
        <span className="ml-auto rounded-md bg-teal-tint px-1.5 py-0.5 font-mono text-[8px] font-bold uppercase tracking-[0.15em] text-teal">
          Faol
        </span>
      </div>
      ...
      <div className="relative h-[480px] space-y-4 overflow-hidden bg-canvas px-5 py-6">
        ...
        <Msg role="ai" delay={step >= 1 ? 0 : 999}>
          ...
          <br />
          • I <span className="rounded bg-teal-tint px-1 font-bold text-teal">went</span> to school yesterday
          <br />
          • She <span className="rounded bg-teal-tint px-1 font-bold text-teal">studied</span> hard
        </Msg>
        ...
        <Msg role="ai" delay={step >= 3 ? 0 : 999} flagged>
          ...
          <span className="rounded bg-teal-tint px-1 font-bold text-teal">
            went
          </span>
          <br />
          <br />
