      ...
      <div className="container-page">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            {/* Title */}
            <h2
              className="mx-auto mt-7 max-w-3xl text-balance font-display font-extrabold text-ink-strong"
              style={{
            ...
            >
              Ta&apos;limni bugun{' '}
              <span className="italic text-hero-gradient">
                o&apos;zgartiring.
              </span>
            </h2>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-rim-2 bg-canvas px-7 py-4 text-base font-semibold text-ink-strong backdrop-blur-md transition-all hover:border-rim-2 hover:bg-soft"
              >
