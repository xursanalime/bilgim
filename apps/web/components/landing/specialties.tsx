...
function Tile({
  ...
  return (
    ...
    >
      <div className="group relative flex aspect-square cursor-pointer flex-col items-center justify-center gap-3 overflow-hidden rounded-3xl border border-rim bg-canvas p-4 transition-all duration-500 hover:-translate-y-1 hover:border-rim-2 hover:shadow-medium">
        {/* Hover radial glow */}
        <div
