        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-2xl border border-rim bg-canvas px-4 py-2.5 text-sm font-semibold text-ink-strong transition-all hover:border-teal/30 hover:bg-teal-tint hover:text-teal"
            >
