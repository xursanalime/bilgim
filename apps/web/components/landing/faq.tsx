...
const FAQS = [
  ...
  },
  {
    ...
    a: "Sizning ochiq sahifangiz (bilgim.uz/t/sizning-username) avtomatik yaratiladi. Qidiruv tizimida ko'rinasiz. Yoki maxsus havola orqali to'g'ridan-to'g'ri taklif qila olasiz.",
  },
  {
