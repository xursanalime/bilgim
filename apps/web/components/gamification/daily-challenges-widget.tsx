      ...
      <div className="flex items-center justify-between px-5 py-3">
        <div className="flex items-center gap-3">
          <div className={cn(
            ...
            allCompleted ? "bg-teal-tint text-teal" : "bg-blue-tint text-blue"
          )}>
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {allCompleted && <PartyPopper className="h-3.5 w-3.5 text-teal" />}
              {!allCompleted && (
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  completed
                    ? "border-teal/15 bg-teal-tint/50"
                ...
                <div className="relative flex h-8 w-8 shrink-0 items-center justify-center">
                  <svg className="h-full w-full rotate-[-90deg]" viewBox="0 0 36 36">
                    ...
                    <motion.circle
                      ...
                      strokeLinecap="round"
                      className={completed ? "text-teal" : "text-blue"}
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between gap-2">
                    <h4 className={cn(
                      ...
                      completed ? "text-teal opacity-80" : "text-ink-strong"
                    )}>
                      {challenge.nameUz}
                    </h4>
