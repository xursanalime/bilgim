        ...
        <div className="flex items-center gap-1 rounded-full border border-rim bg-white p-1 shadow-sm">
          <button
            ...
            className={cn(
              ...
              timeframe === 'GLOBAL' ? "bg-tint-strong text-white shadow-md" : "text-ink-soft hover:bg-tint"
            )}
          >
            Barcha vaqt
          </button>
          <button
            ...
            className={cn(
              "rounded-full px-6 py-2 text-xs font-bold transition-all",
              timeframe === 'WEEKLY' ? "bg-tint-strong text-white shadow-md" : "text-ink-soft hover:bg-tint"
            )}
          >
            Bu hafta
          </button>
