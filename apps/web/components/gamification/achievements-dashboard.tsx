...
const RARITY_COLORS: Record<string, { bg: string; text: string; border: string; shadow: string }> = {
  ...
  RARE: { bg: 'bg-teal/10', text: 'text-teal', border: 'border-teal/20', shadow: 'shadow-teal/20' },
                ...
                return (
                  <div key={i} className="flex flex-col items-center gap-2 flex-1 min-w-0">
                    ...
                    >
                      ...
                      {isActive && !isToday && (
                        <div className="absolute inset-0 rounded-full border-2 border-teal animate-pulse opacity-20" />
                      )}
                    </motion.div>
                    <span className={cn(
                      "text-[8px] sm:text-[9px] font-black uppercase truncate w-full text-center",
                      isToday ? "text-orange" : isActive ? "text-teal" : "text-ink-faint"
                    )}>
              ...
              <div>
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <div className="group relative">
                    ...
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden w-40 sm:w-48 rounded-lg bg-tint-strong p-2 text-[9px] sm:text-[10px] text-white group-hover:block z-20">
                ...
                return (
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="mt-8 w-full border-t border-rim pt-6">
                      {isEarned ? (
                        <div className="flex items-center justify-center gap-2 text-sm font-bold text-teal">
