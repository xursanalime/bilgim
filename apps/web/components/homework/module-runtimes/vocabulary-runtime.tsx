    ...
    <div className="space-y-5">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between text-[11px] font-bold text-white/40">
          ...
          <button type="button" onClick={shuffle} className="flex items-center gap-1 hover:text-white/60 transition-colors">
      ...
      <div
        ...
        aria-label={flipped ? 'Soʻzni koʻrsatish' : 'Tarjimani koʻrsatish'}
        className="relative cursor-pointer select-none rounded-3xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue focus-visible:ring-offset-2 focus-visible:ring-offset-[#14141f]"
