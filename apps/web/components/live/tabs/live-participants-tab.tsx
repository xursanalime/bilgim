      ...
      <div className="flex items-center gap-3 min-w-0 flex-1">
        <div className={cn(
          ...
          {participant.isSpeaking && (
            <div className="absolute inset-0 rounded-xl border-2 border-teal animate-pulse" />
          )}
          {hasHandRaised && (
...
function StatusIcon({ on, OnIcon, OffIcon }: { on: boolean; OnIcon: any; OffIcon: any }) {
  ...
  return (
    <div className={cn('p-1.5 rounded-lg', on ? 'text-teal bg-teal-tint' : 'text-red bg-red-tint')}>
    ...
    <button
      ...
      className={cn(
        ...
        color === 'red'
          ...
          : color === 'green'
            ? 'text-teal/70 hover:text-teal hover:bg-teal-tint'
            : active
