...
import { ModuleTogglePanel } from '../../../../../../../../../../components/dashboard/module-toggle-panel';
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-10 pb-12">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-ink-soft opacity-90">
              Ushbu guruhda o'quvchilar uchun qaysi turdagi vazifalar ruxsat etilganini boshqaring. 
              O&apos;chirilgan modullar yangi vazifalarda ko&apos;rinmaydi, lekin mavjud ma'lumotlar saqlanib qoladi.
            </p>
          </div>
        </div>
      </header>
      ...
      <div className="relative">
        ...
        <ModuleTogglePanel groupId={group.id} initialModules={modules} />
      </div>
    </div>
  );
}
