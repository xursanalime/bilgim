...
// ===================================================================
// Tutor mode (Req 13.1, 13.2, 13.3, 13.6)
// ===================================================================
...
export interface SpecialtyClassifyInput {
  userId: string;
  /** Free-form answer payload from the onboarding quiz. */
  answersJson: unknown;
  /** Slug list known to the platform — model picks one of these. */
  knownSpecialties: string[];
}

export interface SpecialtyClassifyOutput {
  specialtySlug: string;
  /** 0..1 — model's confidence. */
  confidence: number;
  reasoning?: string;
}
...
export interface AiGateway {
  ...
  classifySpecialty(input: SpecialtyClassifyInput): Promise<SpecialtyClassifyOutput>;
