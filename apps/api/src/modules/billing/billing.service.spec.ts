...
describe('BillingService', () => {
  ...
  beforeEach(() => {
    ...
    prisma = {
      ...
      user: {
        // requireActiveSubscription looks up the teacher's email to apply
        // the configured account bypass. Default to a non-bypass email so
        // these tests exercise the normal subscription-enforcement path.
        findUnique: jest
          .fn()
