...
export class EnrollmentController {
  ...
  /**
   * POST /enrollment/groups/:groupId/students/:studentId/revoke — Remove an
   * approved student from a group the calling teacher owns. Flips the
   * Enrollment to REVOKED and drops the student from the group chat.
   * Used by the "Guruhdan chiqarish" action on the "Students" CRM page.
   */
  @Roles('TEACHER')
  @Post('groups/:groupId/students/:studentId/revoke')
  @HttpCode(HttpStatus.OK)
  async revokeEnrollment(
    ...
    return this.enrollmentService.revokeEnrollment(user.sub, groupId, studentId);
  }
