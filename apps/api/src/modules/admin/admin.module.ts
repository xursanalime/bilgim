...
import { AdminCatalogAliasController } from './admin-catalog-alias.controller';
import { AdminOpsController } from './admin-ops.controller';
import { AdminOpsService } from './admin-ops.service';
import { AdminService } from './admin.service';
import { AdminEnglishCatalogController } from './english-catalog.controller';
...
@Module({
  ...
  controllers: [AdminController, AdminOpsController, AdminEnglishCatalogController, AdminCatalogAliasController, AdminProtectionController],
  providers: [
    AdminService,
    AdminOpsService,
    AdminAuditService,
  ...
  exports: [AdminService, AdminOpsService, AdminAuditService, AdminEnglishCatalogService, AdminProtectionSessionsService],
})
