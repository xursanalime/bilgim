...
export const AUDIT_ACTIONS = {
  ...
  // English-Only Platform Refocus — admin English-config management (Req 17.4)
  EXAM_TRACK_CREATED: 'exam_track.created',
  EXAM_TRACK_UPDATED: 'exam_track.updated',
  EXAM_TRACK_ACTIVATED: 'exam_track.activated',
  EXAM_TRACK_DEACTIVATED: 'exam_track.deactivated',
  EXAM_TRACK_DELETED: 'exam_track.deleted',
  MODULE_CATALOG_ENABLED: 'module_catalog.enabled',
  MODULE_CATALOG_DISABLED: 'module_catalog.disabled',
  ...
  // Content protection — leak investigation (Task 4.2, Req 6.3 / 6.4)
  PROTECTION_SESSION_LOOKUP: 'protection.session.lookup',
  PROTECTION_ANOMALY_INGESTED: 'protection.anomaly.ingested',
