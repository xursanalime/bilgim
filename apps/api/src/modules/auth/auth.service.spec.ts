...
describe('AuthService', () => {
  ...
  describe('login', () => {
    ...
    it('allows a PENDING_VERIFY user to log in (email verification not required)', async () => {
      // Email verification is intentionally not enforced at login, so a
      // PENDING_VERIFY account authenticates successfully like any other.
      usersRepository.findByEmail.mockResolvedValue(
