...
## Context
The Edubridge platform requires robust protection against common web attacks (OWASP Top 10) such as SQL Injection, Cross-Site Scripting (XSS), and Path Traversal. We operate in an environment where we need both edge-level protection and application-level fine-grained control.
