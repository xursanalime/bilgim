...
> for the edubridge platform.
>
> **Scope:** Cloudflare zone `edubridge.uz` (and any `*.edubridge.uz`
...
resource "cloudflare_ruleset" "edubridge_waf_custom" {
  zone_id     = var.zone_id
  name        = "edubridge-waf-custom"
  description = "edubridge custom WAF rules"
  kind        = "zone"
...
resource "cloudflare_ruleset" "edubridge_waf_managed_owasp" {
  zone_id     = var.zone_id
  name        = "edubridge-waf-managed-owasp"
  description = "Cloudflare-managed OWASP CRS with edubridge tuning"
  kind        = "zone"
...
resource "cloudflare_ruleset" "edubridge_rate_limit" {
  zone_id     = var.zone_id
  name        = "edubridge-rate-limit"
