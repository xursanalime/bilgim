...
app.enableCors({
  origin: [
    process.env.WEB_URL, // https://bilgim.uz
    process.env.ADMIN_URL, // https://admin.bilgim.uz
  ],
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://api.bilgim.uz wss://api.bilgim.uz",
...
curl -I https://api.bilgim.uz/health
...
URL="${1:-https://api.bilgim.uz/health}"
HEADERS=$(curl -sI "$URL")
MISSING=0
