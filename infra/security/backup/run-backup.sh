...
#       | rclone rcat r2:bilgim-backups/<bucket-prefix>/<filename>.enc
#
...
#   R2_BACKUP_REMOTE            rclone remote name (e.g. `r2:bilgim-backups`)
#   R2_BACKUP_PREFIX            prefix inside the bucket
#                               (e.g. `production/postgres/daily`)
#
# Cron example (run daily at 02:30 UTC):
#
#   30 2 * * *  /opt/bilgim/run-backup.sh >> /var/log/bilgim-backup.log 2>&1
#
